...
const createUser = async (req, res, next) => {
  try {
    ...
    // ademas creo el carrito del usuario
...
const uploadAvatar = async (req, res) => {
  try {
    ...
    const url = process.env.NODE_ENV === 'production' ? `${process.env.URL}/avatars/${file.filename}` : `${process.env.URL}:${process.env.PORT}/avatars/${file.filename}`
